...
// console logging is used intentionally to expose MakinaXRegistry call calldata in view mode
...
contract SetupMakinaXRegistry is Base, Script {
    ...
    {
        Call[] memory setupCalls = registrySetupCalls(infra, feeCollector);
