...
// console logging is used intentionally to expose AccessManager call calldata in view mode
...
contract SetupMakinaXAM is Base, Script {
    ...
    function run() public {
        ...
        Call[] memory calls = amFunctionRoleCalls(_accessManager, _readInfra());
